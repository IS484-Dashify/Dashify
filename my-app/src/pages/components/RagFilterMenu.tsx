      ...
      <Popover.Portal>
        ...
        >
          <div className="flex flex-col gap-2.5">
            <p className="text-indigo-d-500 text-[15px] leading-[19px] font-medium mb-2.5 ">
              Filters
            </p>
            {options.map((option, index) => (
              <fieldset className="flex gap-5 items-center" key={index}>
                <Checkbox.Root
                  className="h-[25px] w-[25px] appearance-none flex items-center justify-center rounded-[4px] bg-white border-1 border-text/20 shadow-lg hover:border-lavender-500 transition-colors duration-200 ease-soft-spring"
                ...
                <label
                  className="-ml-2 text-[15px] leading-none text-text hover:text-lavender-500 transition-colors duration-200 ease-soft-spring cursor-pointer"
